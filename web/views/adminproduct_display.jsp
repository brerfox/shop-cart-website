...
<center>
  ...
  <div class="hot-search">
    ...
    <div class ='product-text'>
        ...
        <a href="edit1.jsp?id=<%=productId  %>&page_id=1" id="add-to-cart" class="button">Edit Product</a>
        <a href="../api/delete_product.jsp?id=<%=productId  %>&page_id=2" id="buy-now" class="button">Delete Product</a>
    </body>
</html>
